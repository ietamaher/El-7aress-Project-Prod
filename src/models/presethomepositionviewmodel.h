...
class PresetHomePositionViewModel : public QObject
{
    ...
    Q_PROPERTY(double currentElevationDeg READ currentElevationDeg NOTIFY currentElevationDegChanged)
...
public:
    ...
    double currentElevationDeg() const { return m_currentElevationDeg; }
