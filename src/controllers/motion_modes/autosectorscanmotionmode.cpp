...
// CONSTRUCTOR
// ============================================================================
AutoSectorScanMotionMode::AutoSectorScanMotionMode(QObject* parent) : GimbalMotionModeBase(parent) {
...
void AutoSectorScanMotionMode::setActiveScanZone(const AutoSectorScanZone& scanZone) {
    ...
    qDebug() << "[AutoScan] Zone Set:" << m_activeScanZone.az1 << "to" << m_activeScanZone.az2
...
void AutoSectorScanMotionMode::updateImpl(GimbalController* controller, double dt) {
    ...
    if (m_state == ScanAzimuth) {
        ...
        double accel = (cfg.motion.scanMaxAccelDegS2 > 0.0) ? cfg.motion.scanMaxAccelDegS2
        ...
        desiredVel = std::clamp(desiredVel, m_previousDesiredAzVel - maxDelta,
        ...
        double globalMax =
            (cfg.motion.maxVelocityDegS > 0.0) ? cfg.motion.maxVelocityDegS : v_max * 1.5;
