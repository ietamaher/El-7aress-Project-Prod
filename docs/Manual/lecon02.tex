...
\hline
\textbf{Main Stick} & Gimbal slew (left/right = azimuth, up/down = elevation) \\
\hline
\textbf{Trigger} & Fire weapon (when armed) \\
\hline
\textbf{Dead Man Switch} & Must be held for weapon operation \\
\hline
\textbf{CAM Button} & Toggle Day/Thermal camera \\
\hline
\textbf{TRK Button} & Initiate/abort tracking \\
\hline
\textbf{LRF Button} & Activate laser rangefinder \\
\hline
\textbf{FN Button} & Context-sensitive function \\
\hline
\textbf{Hat Switch} & Tracking box control / menu navigation \\
\hline
\textbf{Zoom Rocker} & Camera zoom in/out \\
\hline
\end{longtable}
