...
\subsection{STARTUP QUICK REFERENCE CHECKLIST}
...
\subsubsection{Emergency Stop System Details}
...
\textbf{Recovery Period (El-7aress H100 Compliance)}:
\begin{itemize}
...
\subsection{Safety Interlock System}

The El 7arress RCWS employs a comprehensive Safety Interlock system that enforces El-7aress H100 safety requirements. All weapon and motion operations require multiple safety conditions to be met.
...
\hline
NOT in lockout period & 4-second El-7aress spec lockout \\
\hline
...
\subsection{SHUTDOWN QUICK REFERENCE CHECKLIST}
