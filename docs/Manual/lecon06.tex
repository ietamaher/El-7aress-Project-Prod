...
\textbf{VERIFICATION:}
\begin{checklist}
    \item \osd{LEAD ANGLE ON} indicator appears (GREEN)
    \item \osd{LAC} bracket appears on CCIP reticle
    \item Reticle pipper shifts to lead position (ahead of target)
...
\begin{itemize}
    ...
    \item "LAC" bracket visible on reticle
...
\textbf{Display:}
\begin{itemize}
    \item \textcolor{milyellow}{\osd{LEAD ANGLE LAG}} in YELLOW
...
\textbf{Display:}
\begin{itemize}
    \item \textcolor{milred}{\osd{ZOOM OUT}} in RED
