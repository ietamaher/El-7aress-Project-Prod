...
\spectable{
	\begin{tabular}{|L{0.25\textwidth}|L{0.65\textwidth}|}
		...
		\hline
		\textbf{Button 0} & Master Arm \\
		\hline
		\textbf{Button 2} & LAC Toggle (hold Button 3) \\
		\hline
		\textbf{Button 3} & Dead Man Switch \\
		\hline
		\textbf{Button 4} & Track Select (single=start, double=abort) \\
		\hline
		\textbf{Button 5} & Fire \\
		\hline
		\textbf{Button 6/8} & Zoom In/Out \\
		\hline
		\textbf{Button 7/9} & Thermal LUT \\
		\hline
		\textbf{Button 10/12} & Camera Switch \\
		\hline
		\textbf{Button 11/13} & Motion Mode Cycle \\
		\hline
		\textbf{D-Pad} & Acquisition gate sizing (in Acquisition mode) \\
		\hline
	\end{tabular}
}
...
\begin{longtable}{|L{0.30\textwidth}|L{0.60\textwidth}|}
	...
	\hline
	\textcolor{milgreen}{\textbf{LEAD ANGLE ON}} (GREEN) & LAC active, ready to fire \\
	\hline
...
\begin{quickref}
	...
	\begin{enumerate}
		...
		\item Verify: \textcolor{milgreen}{\textbf{LEAD ANGLE ON}} (GREEN)
	\end{enumerate}
	
	\textbf{LAC STATUS MEANINGS}
	
	\begin{itemize}
		\item \textcolor{milgreen}{\textbf{LEAD ANGLE ON}} (GREEN): Ready to fire
