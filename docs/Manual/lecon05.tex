...
% ============================================================================
\section{WEAPON CHARGING (COCKING ACTUATOR) [NEW - QT6]}
...
\hline
LOCKOUT & CHARGING: Lockout (4s) & CROWS M153 4-second post-charge safety period \\
\hline
...
\subsection{4-SECOND CROWS M153 LOCKOUT}

\begin{warningbox}[LOCKOUT PERIOD]
Per CROWS M153 specification, a \textbf{4-second lockout period} follows each completed charging cycle. During this time:
\begin{itemize}
...
\subsubsection{Dead Reckoning During Firing (CROWS Doctrine)}

\begin{warningbox}[IMPORTANT - DEAD RECKONING]
Per CROWS TM 9-1090-225-10-2: "When firing is initiated, CROWS aborts Target Tracking. Instead the system moves according to the speed and direction of the WS just prior to pulling the trigger. CROWS will not automatically compensate for changes in speed or direction of the tracked target during firing."
\end{warningbox}
