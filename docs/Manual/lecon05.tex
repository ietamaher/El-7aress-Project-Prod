...
\hline
\button{Button 4} (double <500ms) & \textbf{EMERGENCY ABORT} & Any phase → Off \\
\hline
...
\textbf{Action:} \textbf{DOUBLE-CLICK \button{Button 4}} (<500ms between presses)
...
\begin{itemize}
    \item Press 1 → Press 2 within \textbf{500 milliseconds} (half-second)
