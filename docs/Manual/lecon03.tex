...
│   ├── Personalize Reticle
│   ├── Personalize Colors
│   └── Display Brightness         [NEW - QT6]
│
├── --- BALLISTICS ---
│   ├── Zeroing (Lesson 6)
│   ├── Clear Active Zero          [NEW - QT6]
│   ├── Windage (Lesson 6)
│   ├── Clear Active Windage       [NEW - QT6]
│   ├── Environmental Settings (Lesson 6)
│   └── Clear Environmental Settings [NEW - QT6]
│
├── --- CALIBRATION ---            [NEW SECTION - QT6]
│   └── Preset Home Position
│
├── --- SYSTEM ---
│   ├── Zone Definitions (Lesson 4)
│   ├── Detection: ENABLED/DISABLED [NEW - QT6]
│   └── Shutdown System
│
├── --- INFO ---
│   ├── Help/About
...
\begin{notebox}[QT6 UPDATE]
The menu structure has been updated with new options for Display Brightness, Calibration section with Preset Home Position, Detection toggle, and separate Clear functions for ballistic settings.
\end{notebox}
...
\subsection{Display Brightness [NEW - QT6]}
...
\section{Calibration Menu Options [NEW SECTION - QT6]}
...
\subsection{Detection Toggle [NEW - QT6]}
